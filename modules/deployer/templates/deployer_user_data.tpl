...
if [ ${enable_bastion} = true ]; then
    ...
    if [ ! -d ${scale_cloud_deployer_path} ]; then sudo git clone -b ${scale_cloud_infra_repo_tag} ${scale_cloud_infra_repo_url} ${scale_cloud_deployer_path}/${scale_cloud_infra_repo_name}; fi
