...
if [ ${enable_bastion} = true ]; then
    ...
    if [ ! -d ${scale_cloud_deployer_path} ]; then sudo git clone -b ${scale_cloud_install_tag} ${scale_cloud_install_repo_url} ${scale_cloud_deployer_path}; fi
    if [ ! -d ${scale_cloud_deployer_path} ]; then sudo git clone -b ${da_hpc_repo_tag} ${scale_cloud_infra_repo_tag} ${scale_cloud_infra_repo_url}; fi
